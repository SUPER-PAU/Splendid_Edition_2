...
america_rooftops = pygame.image.load(r"assets\images\background\america rooftops.png").convert_alpha()
...
kremlin = pygame.image.load(r"assets\images\background\kazanwar.png").convert_alpha()    # 2
subway = pygame.image.load(r"assets\images\background\angar2.png").convert_alpha()    # 2
