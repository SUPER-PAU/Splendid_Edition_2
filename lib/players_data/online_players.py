...
class OnlinePlayer:
    def __init__(self, player, img, name):
        self.player = player
        self.img = img
        self.name = name
...
def load_chara_online():
    ...
    super_pau_online = SuperPauPlayer(1, 400 * display.scr_w, 540 * display.scr_h, False, LISA_DATA, [2, 3, 6, 2, 8],
                                      (sheet.super_pau_2, SUPER_PAU_PLAYER_2_ANIMATION_STEPS))
    lisa_online = LisaPlayer(1400 * display.scr_w, 540 * display.scr_h, True, LISA_DATA, [2, 1, 3, 2, 8],
                             (sheet.lisa_2, LISA_2_ANIMATION_STEPS))
    ...
    ARTESTRO_p = ArtestroPlayer(400 * display.scr_w, 540 * display.scr_h, False, LISA_DATA, [2, 1, 3, 2],
                                (sheet.artestro_2, ARTESTRO_2_ANIMATION_STEPS))
    ...
    AKSENOV_p = AksenovPlayer(400 * display.scr_w, 540 * display.scr_h, False, LISA_DATA, [2, 2, 1, 2],
                              (sheet.aksenov_2, AKSENOV_2_ANIMATION_STEPS))
    ...
    BULAT_p = BulatPlayer(400 * display.scr_w, 540 * display.scr_h, False, LISA_DATA, [2, 2, 2, 2],
                          (sheet.bulat_2, BULAT_2_ANIMATION_STEPS))
    ...
    KINGARTEMA_p = Kingartema(400 * display.scr_w, 540 * display.scr_h, False, KINGARTEMA_DATA, [2, 2, 2, 2],
                              (sheet.kingartema_2, KINGARTEMA_2_ANIMATION_STEPS))
    ...
    EGOR_p = EgorPlayer(400 * display.scr_w, 540 * display.scr_h, False, EGOR_DATA, [2, 2, 2, 2],
                        (sheet.egor_2, EGOR_2_ANIMATION_STEPS))
    ...
    VESISA_p = VesisaPlayer(400 * display.scr_w, 540 * display.scr_h, False, LISA_DATA, [2, 2, 0, 2],
                            (sheet.vesisa_2, VESISA_2_ANIMATION_STEPS))
    ...
    ROBOT_FEM_p = RobotFemalePlayer(400 * display.scr_w, 540 * display.scr_h, False, LISA_DATA, [3, 3, 8, 2],
                                    (sheet.robot_woman_2, ROBOT_WOMAN_2_ANIMATION_STEPS))
    ...
    TAGIR_P = TagirPlayer(400 * display.scr_w, 540 * display.scr_h, False, LISA_DATA, [1, 2, 0, 2],
                          (sheet.tagir_2, TAGIR_2_ANIMATION_STEPS))
    ...
    BT25T_p = Bt25T(400 * display.scr_w, 540 * display.scr_h, False, LISA_DATA, [1, 1, 1, 0],
                    (sheet.bt25t_2, BT25T_2_ANIMATION_STEPS))

    super_pau = OnlinePlayer(super_pau_online, c.pau, "SUPER PAU")
    lisa = OnlinePlayer(lisa_online, c.lisa, "LISA")
    vesisa = OnlinePlayer(VESISA_p, c.vesisa, "VASISA")
    tagir = OnlinePlayer(TAGIR_P, c.tagir, "TAGIR")
    artestro = OnlinePlayer(ARTESTRO_p, c.artestro, "ARTESTRO")
    aksenov = OnlinePlayer(AKSENOV_p, c.aksenov, "AKSENOV")
    bulat = OnlinePlayer(BULAT_p, c.bulat, "BULAT")
    robot_woman = OnlinePlayer(ROBOT_FEM_p, c.robot_woman, "KILLER ROBOT")
    bt25t = OnlinePlayer(BT25T_p, c.bt25, "Bt25t")
    egor = OnlinePlayer(EGOR_p, c.egor, "EGOR")
    kingartema = OnlinePlayer(KINGARTEMA_p, c.kingartema, "KINGARTEMA")
